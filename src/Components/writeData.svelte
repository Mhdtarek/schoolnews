<script lang="ts" >
    import { FormGroup, Input, Label, Col, Row, Button, Container, Dropdown, DropdownMenu, DropdownItem , DropdownToggle} from 'sveltestrap';
    ...
    <Dropdown {isOpen} toggle={() => (isOpen = !isOpen)}>
        ...
        <DropdownMenu dark>
        <DropdownItem color="primary" on:click={() => klass = 'global'}>Alla Klasser</DropdownItem>
    ...
    <Button style="margin-top: 5px;" color="primary" on:click={post}>Lägg</Button>
    </Col>
    </Row>
    {/if}
    {#if docSuccess}
